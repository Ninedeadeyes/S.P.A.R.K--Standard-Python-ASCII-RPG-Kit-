...
def commands(Player):
    ...
    print("                                   ")
    print("Hero Stats ")
    print(f" Level:{Player.level} Health: {Player.health} Power: {Player.power}")
    print(f" Armour:{Player.armour.name} + {Player.armour.protection} Weapon:{Player.weapon.name} + {Player.weapon.damage} Gold: {Player.gold}")
